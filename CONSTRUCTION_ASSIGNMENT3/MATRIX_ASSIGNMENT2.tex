...
\vspace{3cm}
\title{\textbf{LINEAR SYSTEMS AND SIGNAL PROCESSING \\ ASSIGNMENT 2}}
...
\begin{enumerate}
   \item  Show that the matrix A=$\myvec{1 & -1 & 5\\ -1 & 2 & 1\\5 & 1 & 3}$ is a symmetric matrix.
...
\end{align}
Using \eqref{eq:4} and \eqref{eq:5} we get,
\begin{align}
    \Vec{A}=-\Vec{A}^\top
\end{align}
\begin{center}
